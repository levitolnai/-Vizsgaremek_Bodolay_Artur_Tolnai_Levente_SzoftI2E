    ...
    {//Don't forget import Namespace - IApplicationBuilder
        ...
        public static async Task SeedUsersAndRolesAsync(IApplicationBuilder applicationBuilder)
        {
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                ...
                string adminUserEmail = "admin@ehealthweb.com";
                ...
                if(adminUser == null)
                {
                    ...
                    await userManager.CreateAsync(newAdminUser, "Bejelent-12");
                    await userManager.AddToRoleAsync(newAdminUser, UserRoles.Admin);
                }

                string appUserEmail = "user@ehealthweb.com";
                ...
                if (adminUser == null)
                {
                    ...
                    await userManager.CreateAsync(newAppUser, "Bejelent-12");
                    await userManager.AddToRoleAsync(newAppUser, UserRoles.User);
                }
            }
        }
        //private static int RoleManager<T>()
        //{
